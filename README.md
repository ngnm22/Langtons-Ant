...
## How to run
In the command propmt type in initially:
gcc -o ant main.c visualiser.c langton.c -lncursesw

Then once ant.exe is in the folder you can type in "ant" followed by a series of Ls and Rs ie:
ant (for basic langtons)
ant LRLRLRLRRRLLL (for advanced multicoloured langtons)
